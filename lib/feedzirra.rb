...
require 'feedzirra/parser/media_rss_content'
require 'feedzirra/parser/media_rss_copyright'
require 'feedzirra/parser/media_rss_embed_param'
require 'feedzirra/parser/media_rss_embed'
require 'feedzirra/parser/media_rss_href'
require 'feedzirra/parser/media_rss_restriction'
require 'feedzirra/parser/media_rss_scheme'
require 'feedzirra/parser/media_rss_text'
require 'feedzirra/parser/media_rss_thumbnail'
require 'feedzirra/parser/media_rss'
